...
class Bot(BaseBot):
    ...
    async def on_start(self, session_metadata: SessionMetadata) -> None:
        ...
        self.highrise.tg.create_task(self.highrise.teleport(
            session_metadata.user_id, Position(1,50.2,1, "FrontRight")))
...
if __name__ == "__main__":
    room_id ="6283c992fd6b2ad8bbc2f832" 
    token = "b16ff9e3abf91a74d3e22bc0e2c39be7296924a930dcde775936cacfb9952449"
